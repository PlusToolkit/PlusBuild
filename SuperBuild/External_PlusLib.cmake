...
IF(PLUS_USE_CLARIUS_OEM)
  LIST(APPEND PLUSBUILD_ADDITIONAL_SDK_ARGS
    ...
    -DClariusOEM_DIR:PATH=${ClariusOEM_DIR}
    )
ENDIF()
...
IF(PLUS_USE_DAQ_USB3FRM13B_CAM)
  LIST(APPEND PLUSBUILD_ADDITIONAL_SDK_ARGS
    -DDAQ_USB3FRM13B_SDK_INCLUDE_DIR:PATH=${DAQ_USB3FRM13B_SDK_INCLUDE_DIR}
    -DDAQ_USB3FRM13B_SDK_LIBRARY:PATH=${DAQ_USB3FRM13B_SDK_LIBRARY}
    -DDAQ_USB3FRM13B_SDK_BINARY:PATH=${DAQ_USB3FRM13B_SDK_BINARY}
    -DDAQ_USB3FRM13B_SDK_DIR:PATH=${DAQ_USB3FRM13B_SDK_DIR}
  )
ENDIF()
...
ExternalProject_Add(PlusLib
  ...
  CMAKE_ARGS
    ...
    -DPLUS_USE_DAQ_USB3FRM13B_CAM:BOOL=${PLUS_USE_DAQ_USB3FRM13B_CAM}
