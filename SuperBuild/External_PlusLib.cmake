...
IF(PLUS_USE_DAQUSB3FRM13B_CAM)
  LIST(APPEND PLUSBUILD_ADDITIONAL_SDK_ARGS
    -DDAQUSB3FRM13B_SDK_INCLUDE_DIR:PATH=${DAQUSB3FRM13B_SDK_INCLUDE_DIR}
    -DDAQUSB3FRM13B_SDK_LIBRARY:PATH=${DAQUSB3FRM13B_SDK_LIBRARY}
    -DDAQUSB3FRM13B_SDK_BINARY:PATH=${DAQUSB3FRM13B_SDK_BINARY}
    -DDAQUSB3FRM13B_SDK_DIR:PATH=${DAQUSB3FRM13B_SDK_DIR}
  )
ENDIF()
...
ExternalProject_Add(PlusLib
  ...
  CMAKE_ARGS
    ...
    -DPLUS_USE_DAQUSB3FRM13B_CAM:BOOL=${PLUS_USE_DAQUSB3FRM13B_CAM}
