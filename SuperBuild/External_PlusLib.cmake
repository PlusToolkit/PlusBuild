...
IF(PLUS_USE_INTELREALSENSE_CAM)
  LIST(APPEND PLUSBUILD_ADDITIONAL_SDK_ARGS
    -DRSSDKCAM_INCLUDE_DIR:PATH=${RSSDKCAM_INCLUDE_DIR}
    -DRSSDKCAM_LIBRARY:PATH=${RSSDKCAM_LIBRARY}
    -DRSSDKCAM_BINARY:PATH=${RSSDKCAM_BINARY}
    )
ENDIF()
...
ExternalProject_Add(PlusLib
  ...
  CMAKE_ARGS
	...
	-DPLUS_USE_INTELREALSENSE_CAM:BOOL=${PLUS_USE_INTELREALSENSE_CAM}
