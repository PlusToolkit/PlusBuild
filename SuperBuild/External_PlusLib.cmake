...
IF(PLUS_USE_OPTITRACK)
  LIST(APPEND PLUSBUILD_ADDITIONAL_SDK_ARGS
    -DOPTITRACK_INCLUDE_DIR:PATH=${OPTITRACKSDK_INCLUDE_DIR}
    -DOPTITRACK_LIBRARY_DIR:PATH=${OPTITRACKSDK_LIBRARY_DIR}
    -DOPTITRACK_BINARY_DIR:PATH=${OPTITRACKSDK_BINARY_DIR}
    )
ENDIF()
...
IF(PLUS_USE_RTSP_VIDEO)
  STRING(REPLACE ";" "|" _tmp_FFMPEG_BINARIES "${FFMPEG_BINARIES}")
  STRING(REPLACE ";" "|" _tmp_FFMPEG_LIBRARIES "${FFMPEG_LIBRARIES}")
  STRING(REPLACE ";" "|" _tmp_FFMPEG_INCLUDE_DIRS "${FFMPEG_INCLUDE_DIRS}")
  LIST(APPEND PLUSBUILD_ADDITIONAL_SDK_ARGS
    -DFFMPEG_INCLUDE_DIRS:PATH=${_tmp_FFMPEG_INCLUDE_DIRS}
    -DFFMPEG_LIBRARIES:FILEPATH=${_tmp_FFMPEG_LIBRARIES}
    -DFFMPEG_BINARIES:FILEPATH=${_tmp_FFMPEG_BINARIES}
    )
ENDIF()
