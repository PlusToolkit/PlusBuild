...
if(OPENVR_FOUND)
  if(OPENVR_ROOT_DIR STREQUAL "")
    get_filename_component(_root_dir ${OPENVR_INCLUDE_DIR} DIRECTORY)
    set(OPENVR_ROOT_DIR ${_root_dir} CACHE PATH "Directory to search for OpenVR SDK" FORCE)
  endif()
  ...
  set_target_properties(OpenVR 
    PROPERTIES
      ...
      IMPORTED_LOCATION_RELEASE ${OPENVR_ROOT_DIR}/bin/${OPENVR_PLATFORM}/openvr_api${CMAKE_SHARED_LIBRARY_SUFFIX}
      INTERFACE_INCLUDE_DIRECTORIES ${OPENVR_INCLUDE_DIRS}
  )
  if(MSVC)
  set_target_properties(OpenVR
    PROPERTIES
      PDB_NAME ${OPENVR_ROOT_DIR}/bin/${OPENVR_PLATFORM}/openvr_api.pdb
    )
  endif()
endif()
