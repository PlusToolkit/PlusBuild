...
SET( ICCAPTURING_PATH_HINTS
  "../ImagingControl-3.5"
  "../PLTools/ImagingControl/ImagingControl-3.5"
  "../../PLTools/ImagingControl/ImagingControl-3.5"
  "../trunk/PLTools/ImagingControl/ImagingControl-3.5"
  "${CMAKE_CURRENT_BINARY_DIR}/PLTools/ImagingControl/ImagingControl-3.5"
  )
...
FIND_LIBRARY(ICCAPTURING_TIS_UDSHL_STATIC_LIB
  NAMES TIS_UDSHL12${PLATFORM_SUFFIX}
  PATH_SUFFIXES "/win32/release" "/x64/release"
  PATHS ${ICCAPTURING_PATH_HINTS}
  )
FIND_FILE(ICCAPTURING_TIS_UDSHL_SHARED_LIB
  NAMES TIS_UDSHL12${PLATFORM_SUFFIX}${CMAKE_SHARED_LIBRARY_SUFFIX}
  PATH_SUFFIXES "/win32/release" "/x64/release"
  PATHS ${ICCAPTURING_PATH_HINTS}
  )
FIND_LIBRARY(ICCAPTURING_TIS_UDSHLD_STATIC_LIB
  NAMES TIS_UDSHL12d${PLATFORM_SUFFIX}
  PATH_SUFFIXES "/win32/debug" "/x64/debug"
  PATHS ${ICCAPTURING_PATH_HINTS}
  )
FIND_FILE(ICCAPTURING_TIS_UDSHLD_SHARED_LIB
  NAMES TIS_UDSHL12d${PLATFORM_SUFFIX}${CMAKE_SHARED_LIBRARY_SUFFIX}
  PATH_SUFFIXES "/win32/debug" "/x64/debug"
  PATHS ${ICCAPTURING_PATH_HINTS}
  )
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(ICCAPTURING  DEFAULT_MSG
  ...
  ICCAPTURING_TIS_UDSHL_STATIC_LIB
  ICCAPTURING_TIS_UDSHL_SHARED_LIB
  ICCAPTURING_TIS_UDSHLD_STATIC_LIB
